...
class GetRuleTemplates extends AbstractRules
{
    ...
    protected function setQueryParameters(): void
    {
        $this->editableQueryParameters = [
            ...
            self::QUERY_PARAMETER_TEMPLATE_NAME     => new GenericQueryParameter(self::QUERY_PARAMETER_TEMPLATE_NAME, GenericQueryParameter::TYPE_STRING, 'Returns the Rule Template under the given Rule Name'),
            self::QUERY_PARAMETER_TEMPLATE_TYPE     => new GenericQueryParameter(self::QUERY_PARAMETER_TEMPLATE_TYPE, GenericQueryParameter::TYPE_STRING, 'Specifying DEFAULT returns only default Rule Templates, CUSTOM returns only those created by the account holder or ALL returns all Rule Templates'),
