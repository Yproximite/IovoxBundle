...
class GetVoxnumberRegionsModel extends PaginateResponse
{
    /**
     * @param Collection<int, VoxnumberRegionModel> $results
     */
    ...
    public static function create(array $opts): self
    {
        ...
        return new self(
            ...
            (new ArrayCollection(static::formatResult($response)))->map(fn ($v): VoxnumberRegionModel => VoxnumberRegionModel::create($v))
        );
    }
}
