...
class GetCallFlows extends AbstractCallFlow
{
    ...
    protected function setQueryParameters(): void
    {
        $this->editableQueryParameters = [
            ...
            static::QUERY_PARAMETER_TEMPLATE_NAME   => new GenericQueryParameter(static::QUERY_PARAMETER_TEMPLATE_NAME, GenericQueryParameter::TYPE_STRING, 'Returns the Call Flow under the given Call Flow title'),
            static::QUERY_PARAMETER_TEMPLATE_TYPE   => new GenericQueryParameter(static::QUERY_PARAMETER_TEMPLATE_TYPE, GenericQueryParameter::TYPE_STRING, 'Specifying DEFAULT returns only default Call Flows, CUSTOM returns only those created by the account holder or ALL returns all Call Flows'),
