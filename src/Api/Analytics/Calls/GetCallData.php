...
class GetCallData extends AbstractCalls
{
    ...
    protected function setQueryParameters(): void
    {
        $this->editableQueryParameters = [
            ...
            static::QUERY_PARAMETER_SDT                 => new GenericQueryParameter(static::QUERY_PARAMETER_SDT, GenericQueryParameter::TYPE_STRING, 'Returns all calls received since a given date. Start date format is YYYY-MM-DD HH:MM:SS with hours, minutes and seconds being optional. Hours, minutes and seconds defaults to 00:00:00'),
            static::QUERY_PARAMETER_EDT                 => new GenericQueryParameter(static::QUERY_PARAMETER_EDT, GenericQueryParameter::TYPE_STRING, 'Returns all calls received before a given date. End date format is YYYY-MM-DD HH:MM:SS with hours, minutes and seconds being optional. Hours, minutes and seconds defaults to 23:59:59'),
            static::QUERY_PARAMETER_DCONST              => new GenericQueryParameter(static::QUERY_PARAMETER_DCONST, GenericQueryParameter::TYPE_STRING, "Shortcut to request calls received on a particular date
YESTERDAY : Return yesterday's calls, from 00:00:00 to 23:59:59"),
            static::QUERY_PARAMETER_ID                  => new GenericQueryParameter(static::QUERY_PARAMETER_ID, GenericQueryParameter::TYPE_STRING, 'Returns the Call with the specified Call ID'),
            static::QUERY_PARAMETER_NODE_ID             => new GenericQueryParameter(static::QUERY_PARAMETER_NODE_ID, GenericQueryParameter::TYPE_STRING, 'Returns all calls for the specified Node ID'),
            static::QUERY_PARAMETER_NODE_TYPE           => new GenericQueryParameter(static::QUERY_PARAMETER_NODE_TYPE, GenericQueryParameter::TYPE_STRING, 'Returns all calls for the specified Node Type'),
            static::QUERY_PARAMETER_LINK_ID             => new GenericQueryParameter(static::QUERY_PARAMETER_LINK_ID, GenericQueryParameter::TYPE_STRING, 'Returns all calls for the specified Link ID'),
            static::QUERY_PARAMETER_LINK_TYPE           => new GenericQueryParameter(static::QUERY_PARAMETER_LINK_TYPE, GenericQueryParameter::TYPE_STRING, 'Returns all calls for the specified Link Type'),
            static::QUERY_PARAMETER_CTYPE               => new GenericQueryParameter(static::QUERY_PARAMETER_CTYPE, GenericQueryParameter::TYPE_STRING, 'Returns all data under the given call type, e.g. DIRECT or API'),
            static::QUERY_PARAMETER_CALL_RES            => new GenericQueryParameter(static::QUERY_PARAMETER_CALL_RES, GenericQueryParameter::TYPE_STRING, 'Returns all data under the given call result, e.g. ANSWERED'),
            static::QUERY_PARAMETER_RULE_RES            => new GenericQueryParameter(static::QUERY_PARAMETER_RULE_RES, GenericQueryParameter::TYPE_STRING, 'Returns all data under the given rule result, e.g. Call to an Operator'),
            static::QUERY_PARAMETER_CALL_ORIGIN         => new GenericQueryParameter(static::QUERY_PARAMETER_CALL_ORIGIN, GenericQueryParameter::TYPE_STRING, 'Returns all data under the given call origin, e.g. 447966111222'),
            static::QUERY_PARAMETER_CALL_ORIGIN_ENCODED => new GenericQueryParameter(static::QUERY_PARAMETER_CALL_ORIGIN_ENCODED, GenericQueryParameter::TYPE_STRING, 'Returns all data under the given call origin encoded, the 4 first digits are not encoded (country code and area code)
e.g. 44798833057321'),
            static::QUERY_PARAMETER_VOXNUMBER           => new GenericQueryParameter(static::QUERY_PARAMETER_VOXNUMBER, GenericQueryParameter::TYPE_STRING, 'Returns all data under the given VoxNumber, e.g. 448456111222'),
            static::QUERY_PARAMETER_CALL_DEST           => new GenericQueryParameter(static::QUERY_PARAMETER_CALL_DEST, GenericQueryParameter::TYPE_STRING, 'Returns all data under the given call destination, e.g. 447966123456'),
            static::QUERY_PARAMETER_DIRECTION           => new GenericQueryParameter(static::QUERY_PARAMETER_DIRECTION, GenericQueryParameter::TYPE_STRING, '	Returns all data under the given direction e.g. IN'),
            static::QUERY_PARAMETER_DETAIL              => new GenericQueryParameter(static::QUERY_PARAMETER_DETAIL, GenericQueryParameter::TYPE_STRING, 'Returns all data for the given detail. This includes IP Address (for makeTwoWayCall) and conference room number'),
            static::QUERY_PARAMETER_CAT_IDS             => new GenericQueryParameter(static::QUERY_PARAMETER_CAT_IDS, GenericQueryParameter::TYPE_STRING, 'Returns all data for the given category IDs. To produce an AND based search separate each by a comma and to produce an OR based, separate as array elements. For example, cat_ids[]=1,2&cat_ids[]=3,4 would search where category ID is (1 AND 2) OR (3 AND 4). Note: if a search is made for Category ID 5, potentially Location = London, results will include any items further down the tree, such as Notting Hill'),
            static::QUERY_PARAMETER_REQ_FIELDS          => new GenericQueryParameter(static::QUERY_PARAMETER_REQ_FIELDS, GenericQueryParameter::TYPE_STRING, 'Comma separated list of abbreviated fields to return in response.
id=id
cs=Call Start
ce=Call End
co=Call Origin
