...
class GetBlockedNumbersModel extends PaginateResponse
{
    /**
     * @param Collection<int, BlockedNumberModel> $results
     */
    ...
    public static function create(array $opts): self
    {
        ...
        return new self(
            ...
            (new ArrayCollection(static::formatResult($response)))->map(fn ($v): BlockedNumberModel => BlockedNumberModel::create($v))
        );
    }
}
