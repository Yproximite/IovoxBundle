 ...
 */
class GetCallMetrics extends AbstractCalls
{
    ...
    protected function setQueryParameters(): void
    {
        $this->editableQueryParameters = [
            ...
            static::QUERY_PARAMETER_CALL_ORIGIN_ENCRYPTION => new GenericQueryParameter(static::QUERY_PARAMETER_CALL_ORIGIN_ENCRYPTION, GenericQueryParameter::TYPE_STRING, 'Returns all data under the given call origin encrypted, e.g. 4478_516CD74E0509B222'),
