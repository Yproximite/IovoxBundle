...
class GetCallMetricsModel extends PaginateResponse
{
    /**
     * @param Collection<int, CallMetricModel> $results
     */
    ...
    public static function create(array $opts): self
    {
        ...
        return new self(
            ...
            (new ArrayCollection(static::formatResult($response)))->map(fn ($v): CallMetricModel => CallMetricModel::create($v))
        );
    }
}
