...
class GetLinksModel extends PaginateResponse
{
    /**
     * @param Collection<int, LinkModel> $results
     */
    ...
    public static function create(array $opts): self
    {
        ...
        return new self(
            ...
            (new ArrayCollection(static::formatResult($response)))->map(fn ($v): LinkModel => LinkModel::create($v))
        );
    }
}
