...
class DeleteCategories extends AbstractCategories
{
    ...
    protected function setErrorResults(): void
    {
        $this->errorResults = [
            ...
            new GenericErrorResult(400, 'Category ID x of y does not exist', 'Correct category_id x (item) of y (total)'),
            new GenericErrorResult(400, 'Category ID x of y Empty', 'Correct category_id x (item) of y (total)'),
