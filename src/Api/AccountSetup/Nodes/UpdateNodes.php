...
/**
 * @see https://docs.iovox.com/display/RA/updateNodes
 */
class UpdateNodes extends AbstractNodes implements UpdateNodesInterface, XmlQueryStringInterface
{
    ...
    public function executeQuery(NodesPayload $payload): bool
    {
        ...
        $validate = $this->validator->validate($payload, null, [NodesPayload::GROUP_UPDATE]);
        if ($validate->count() > 0) {
            throw new ValidationPayloadException($validate);
        }

        $query->setContent($this->serializer->serialize($payload, 'xml', ['groups' => [NodesPayload::GROUP_UPDATE]]));
    ...
    protected function setQueryParameters(): void
    {
        ...
        $this->allQueryParameters = array_merge([
            ...
            MethodQueryParameter::getParameterName()  => new MethodQueryParameter('updateNodes'),
        ], $this->editableQueryParameters);
    }
