...
class GetVoxnumbersModel extends PaginateResponse
{
    /**
     * @param Collection<int, VoxnumberModel> $results
     */
    ...
    public static function create(array $opts): self
    {
        ...
        return new self(
            ...
            (new ArrayCollection(static::formatResult($response)))->map(fn ($v): VoxnumberModel => VoxnumberModel::create($v))
        );
    }
}
