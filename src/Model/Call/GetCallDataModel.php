...
class GetCallDataModel extends PaginateResponse
{
    /**
     * @param Collection<int, CallDataModel> $results
     */
    ...
    public static function create(array $opts): self
    {
        ...
        return new self(
            ...
            (new ArrayCollection(static::formatResult($response)))->map(fn ($v): CallDataModel => CallDataModel::create($v))
        );
    }
}
