...
/**
 * @see https://docs.iovox.com/display/RA/updateContacts
 */
class UpdateContacts extends AbstractContacts implements UpdateContactsInterface, XmlQueryStringInterface
{
    ...
    public function executeQuery(ContactsPayload $payload): bool
    {
        ...
        $validate = $this->validator->validate($payload, null, [ContactsPayload::GROUP_UPDATE]);
        if ($validate->count() > 0) {
            throw new ValidationPayloadException($validate);
        }

        $query->setContent($this->serializer->serialize($payload, 'xml', ['groups' => [ContactsPayload::GROUP_UPDATE]]));
    ...
    protected function setQueryParameters(): void
    {
        ...
        $this->allQueryParameters = array_merge([
            ...
            MethodQueryParameter::getParameterName()  => new MethodQueryParameter('updateContacts'),
        ], $this->editableQueryParameters);
    }
