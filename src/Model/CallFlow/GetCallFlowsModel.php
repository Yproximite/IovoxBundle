...
class GetCallFlowsModel extends PaginateResponse
{
    /**
     * @param Collection<int, CallFlowModel> $results
     */
    ...
    public static function create(array $opts): self
    {
        ...
        return new self(
            ...
            (new ArrayCollection(static::formatResult($response)))->map(fn ($v): CallFlowModel => CallFlowModel::create($v))
        );
    }
}
