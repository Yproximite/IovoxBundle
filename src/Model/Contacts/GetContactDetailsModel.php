...
class GetContactDetailsModel extends PaginateResponse
{
    /**
     * @param Collection<int, ContactDetailsModel> $results
     */
    ...
    public static function create(array $opts): self
    {
        ...
        return new self(
            ...
            (new ArrayCollection(static::formatResult($response)))->map(fn ($v): ContactDetailsModel => ContactDetailsModel::create($v))
        );
    }
}
